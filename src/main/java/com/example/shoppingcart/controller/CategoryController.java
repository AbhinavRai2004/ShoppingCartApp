...
import com.example.shoppingcart.service.category.ICategoryService;
...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponse> getAllCategories(){
        try {
            ...
            return ResponseEntity.status(INTERNAL_SERVER_ERROR).body(new ApiResponse("Get all categories failed!", e.getMessage()));
        }
    }
    ...
    public ResponseEntity<ApiResponse> addCategory(@RequestBody Category category){
        try{
            ...
            return ResponseEntity.status(CONFLICT).body(new ApiResponse("Add category failed!", e.getMessage()));
        }
    }
