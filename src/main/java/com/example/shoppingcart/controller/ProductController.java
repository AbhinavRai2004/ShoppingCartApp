...
public class ProductController {
    ...
    public ResponseEntity<ApiResponse> getAllProducts(){
        ...
        return ResponseEntity.ok(new ApiResponse("Get all products success!", convertedProduct));
    }
    ...
    public ResponseEntity<ApiResponse> getProductByCategoryNameAndBrand(@RequestParam String category, @RequestParam String brand){
        try {
